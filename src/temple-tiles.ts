...
export function baseTempleTileSupply(playerCount:number):TempleTileSupply{if(!Number.isInteger(playerCount)||playerCount<1||playerCount>4)throw new Error('Arnak supports 1-4 players');return{bronze:3*playerCount,bronzeA:playerCount,bronzeB:playerCount,bronzeC:playerCount,silver:2*playerCount,silverLeft:playerCount,silverRight:playerCount,gold:playerCount};}
