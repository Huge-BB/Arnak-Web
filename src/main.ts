...
function supplyBoard(){
  ...
  const supplyDecks=[
    {label:'一级地点',src:'/assets/site-level1-back.jpg',count:state.discovery.level1Deck.length,x:400,width:300,height:380},
    {label:'二级地点',src:'/assets/site-level2-back.jpg',count:state.discovery.level2Deck.length,x:980,width:330,height:376},
    {label:'守卫',src:'/assets/guardian-back.jpg',count:state.discovery.guardianDeck.length,x:1580,width:360,height:360},
