...
function supplyBoard(){
  ...
  return`<aside class="supply-board"><img src="${publicAsset('/assets/boards/supply-board-web.webp')}" alt="supply board"><div class="supply-assistant-stacks">${assistants}${researchStarts}</div></aside>`;
}
